...
static float computeRectifierRippleHz(const Radio1938& radio) {
...
static float computeRectifierRippleWave(
...
static float clampPowerSupplyScale(const Radio1938::PowerNodeState& power,
                                   float scale) {
